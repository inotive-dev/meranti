...
@section('content')
    <div class="row">
        <div class="col-12 text-end">
            <a href="{{ route('dashboard.user.create') }}" class="btn btn-primary btn-create">
                ...
                <tbody>
                    ...
                    @foreach($users as $key => $user)
                        <tr>
                            ...
                            <td class="align-middle text-nowrap">{{ $user->position ?? '-' }}</td>
                            <td class="text-nowrap">
                                <a href="{{ route('dashboard.user.edit', $user->id) }}" class="btn btn-outline-primary btn-edit" value="{{ $user->id }}">
                                    <i data-feather="edit" class="align-middle"></i>
                                    <span class="ms-1 align-middle">Edit</span>
                                </a>
                                <button class="btn btn-outline-danger btn-delete" value="{{ $user->id }}">
