          ...
          <table class="table">
            ...
            <tbody>
              @php
                $no = 1;  
              @endphp
              @foreach($setting_job_request as $setting_job_request_item)
                <tr>
                  <td class="align-middle">{{ $no++ }}</td>
                  <td class="align-middle">{{ $setting_job_request_item->title ?? '-' }}</td>
                  <td class="align-middle">{{ $setting_job_request_item->level ?? '-' }}</td>
                  <td class="text-nowrap">"
                    <a href="{{ route('dashboard.setting.job-request.show', $setting_job_request_item->id) }}" class="btn btn-outline-info" data-id="{{ $setting_job_request_item->id }}">
