    ...
    <div class="container">
        <div class="row">
            <div class="col-12 ">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('dashboard.setting.s-note.update', 'update') }}" method="POST" id="create-form" enctype="multipart/form-data">
                            @csrf
                            @method("PUT")
                            <div class="mb-3">
...
@section('script')
  <script>
    ...
    $(document).on("click", ".btn-edit", function()
    {
      ...
      $("#edit-form").attr("action", "{{ route('dashboard.setting.s-note.index') }}/" + id);
      $.ajax({
        method: "GET",
        url: "{{ route('dashboard.setting.s-note.index') }}/" + id + "/edit?_token={{ csrf_token() }}"
    ...
    {
      var id = $(this).data('id');
      $("#delete-form").attr("action", "{{ route('dashboard.setting.s-note.index') }}/" + id);
