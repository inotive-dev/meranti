...
@section('breadcrumb')
  <div class="row">
    <div class="col-6">
      <h3>Setting Judul Opname Report</h3>
    </div>
    <div class="col-6">
      <ol class="breadcrumb">
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('dashboard.setting.opname-report.update', 'update') }}" method="POST" id="create-form" enctype="multipart/form-data">
                            @csrf
                            @method("PUT")
...
@section('script')
  <script>
    ...
    $(document).on("click", ".btn-edit", function()
    {
      ...
      $("#edit-form").attr("action", "{{ route('dashboard.setting.opname-report.index') }}/" + id);
      $.ajax({
        method: "GET",
        url: "{{ route('dashboard.setting.opname-report.index') }}/" + id + "/edit?_token={{ csrf_token() }}"
    ...
    {
      var id = $(this).data('id');
      $("#delete-form").attr("action", "{{ route('dashboard.setting.opname-report.index') }}/" + id);
