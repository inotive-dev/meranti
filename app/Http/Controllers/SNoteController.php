...
use App\Models\SNote;

class SNoteController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $data['title'] = 'Detail S-Note';
        
        return view('dashboard.s-note.index', $data);
    }
    ...
    public function show($id)
    {
        ...
        $data['title'] = 'S-Note Item';

        return view('dashboard.s-note.show', $data);
    }
